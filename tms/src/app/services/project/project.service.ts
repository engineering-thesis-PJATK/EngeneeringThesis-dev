...
export class ProjectService {
  ...
  getProjectsExtended(): Observable<Project[]> {
    return this.http.get<Project[]>(this.url+ApiPaths.ProjectExtended).pipe(tap(console.log));
  }
  ...
  getProject(id: string): Observable<Project> {
    ...
    //let project: Project =  { proId: 1, proName: 'first project', proDescription: 'description dfjlkfdjfksfdsfdsfsfdsf  sdf sdf', proIdCompany: 1, /*companyName: 'first compnay',*/ proIdTeam: 1, /*teamName: 'abc team name'*/};
    //return of(project);
  }
